...
(function (root) {
  ...
  // Cherche l'image FULL ART : impression dont art_variations contient « FA »
  // (c'est la face pleine-illustration des Marvel, ex. ROS254-MV_BACK.png).
  function findFullArtImageUrl(obj, depth) {
    ...
    if (typeof obj === 'object') {
      ...
      if (isFA && typeof url === 'string') return url;
